...
/**
 * Formatação monetária padrão do projeto.
 */
...
/**
 * Retorna há quanto tempo a comanda foi aberta.
 */
...
/**
 * Define o visual de cada status.
 */
function obterVisualComanda(status) {
    switch (status) {
        ...
        case "Cancelada":
            return {
                label: "Cancelada",
                cardClass: styles.cardCanceled,
                badgeClass: styles.badgeCanceled
            };
                ...
                <div className={styles.emptyState}>
                    ...
                    <p>
                        {busca
                            ...
                            : "Não existem comandas para o status selecionado."}
                    </p>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={styles.cardFooter}>
                                    <Link
                                        href={`/admin/mesas/${comanda.mesa_id}`}
                                        className={
                                            styles.manageButton
                                        }
                                    >
